...
# =========================================
 ...
 [
  ...
  [
   ...
   ("Ctrl","WinLeft",'Fn','Alt','\t\tSpace\t\t','Alt','WinRight','Ctrl')
  ]
 ]
],
[
...
class Keyboard(Tkinter.Frame):
 ...
 def create_frames_and_buttons(self):
  ...
  for key_section in keys:
   ...
   store_section.pack(side='left',expand='yes',fill='both',padx=2,pady=10,ipadx=10,ipady=10)
   ...
   for layer_name, layer_properties, layer_keys in key_section:
    ...
    for key_bunch in layer_keys:
     ...
     for k in key_bunch:
      # k=k.capitalize()
      if len(k)<=3:
       store_button = ttk.Button(store_key_frame, text=k, width=2)
      else:
       store_button = ttk.Button(store_key_frame, text=k.center(5,' '))
      if " " in k:
       store_button['state']='disable'
      # flat, groove, raised, ridge, solid, or sunken
      # store_button['relief']="groove"
      # store_button['bg']="SystemButtonFace"
